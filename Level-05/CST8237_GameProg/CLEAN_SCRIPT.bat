...
IF ERRORLEVEL == 1 (
    SET "error_msg=The name of the current folder does not contain 'Lab' or 'Assignment'."
)
...
SET "excluded_folders=Source Config Content"

:: Set the list of excluded file extensions (e.g., .uproject)
SET "excluded_extensions=.uproject .bat"
